# ------------------------------------------------------------------------------
# LEiDA FO prediction from air pollution (K=13; O3)
# ------------------------------------------------------------------------------
...
fit3 <- brm(
  formula = cbind(P_k13c1, P_k13c2, P_k13c3, P_k13c4, P_k13c5, P_k13c6, P_k13c7, 
                  P_k13c8, P_k13c9, P_k13c10, P_k13c11, P_k13c12, P_k13c13) 
  ~ reshist_addr1_o3_prenatal_avg*reshist_addr1_adi_quint + demo_sex_v2 + 
...
fit4 <- brm(
  formula = cbind(P_k13c1, P_k13c2, P_k13c3, P_k13c4, P_k13c5, P_k13c6, P_k13c7, 
                  P_k13c8, P_k13c9, P_k13c10, P_k13c11, P_k13c12, P_k13c13) 
  ~ reshist_addr1_o3_2016_annavg*reshist_addr1_adi_quint + demo_sex_v2 + 
    pubertal_dev_score + interview_age + race_ethnicity + birth_weight_kg,
  data = data_rescaled,
  family = dirichlet,
  cores = 8, seed = 1
