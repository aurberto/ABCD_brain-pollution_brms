# ------------------------------------------------------------------------------
# Mediation analysis between LEiDA lifetimes, mental health, and air pollution (K=13; O3)
# ------------------------------------------------------------------------------
...
models_path <- paste0("/path/to/results/dwell_times/mediations/",pollutant)
# Create directory if not exist
if (!dir.exists(models_path)) {
  dir.create(models_path, recursive = TRUE)
}

tables_path <- paste0("/path/to/results/dwell_times/mediations/tables/",pollutant)
# Create directory if not exist
...
exposures <- c("reshist_addr1_o3_prenatal_avg",
