# ------------------------------------------------------------------------------
# Mediation analysis between FCH power/energy, mental health, and air pollution (H6; PM2.5)
# ------------------------------------------------------------------------------
...
models_path <- paste0("/path/to/results/fch/mediations/",pollutant)
# Create directory if not exist
if (!dir.exists(models_path)) {
  dir.create(models_path, recursive = TRUE)
}

tables_path <- paste0("/path/to/results/fch/mediations/tables/",pollutant)
# Create directory if not exist
...
exposures <- c("reshist_addr1_pm25_prenatal_avg",
